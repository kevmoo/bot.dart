library bot.test.collection.enumerable;
...
List<String> _getChars(String input) {
...
// Grouping
//
void _testComplexGrouping() {
  int keyFunc(str) => str.length;
