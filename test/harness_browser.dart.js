...
$$.NonExtensibleListMixin = {"": "Iterable;",
  ...
  contains$1: function(value) {
    ...
    while (true) {
      ...
      if (typeof t2 !== "number")
        return this.contains$1$bailout1(1, value, t2, i);
      if (!(i < t2))
        break;
  ...
  contains$1$bailout1: function(state0, env0, env1, env2) {
    switch (state0) {
      case 1:
        i = env2;
        t2 = env1;
...
$$.ListBase = {"": "NonExtensibleListMixin;"};
...
$$._SimpleNumEnumerable = {"": "NumberEnumerable;_source",
  get$iterator: function() {
    return $.CONSTANT1.get$iterator(this._source);
  }
};
...
$$._RangeIterator = {"": "Object;_start,_count,_liblib3$_current",
  ...
  moveNext$0$bailout2: function(state0, env0, env1, env2) {
    switch (state0) {
      case 1:
        t1 = env0;
        break;
...
$$.Box = {"": "Object;left>,top>,width>,height>",
  ...
  contains$1: function(point) {
    ...
    t1 = point.get$x();
    if (typeof t1 !== "number")
      return this.contains$1$bailout2(1, point, t1);
    t3 = this.left;
    if (typeof t3 !== "number")
      return this.contains$1$bailout2(2, point, t3, t1);
    if (t1 >= t3) {
      t2 = this.width;
      if (typeof t2 !== "number")
        return this.contains$1$bailout2(4, point, t1, t3, t2);
      if (t1 <= t3 + t2) {
        t1 = point.get$y();
        if (typeof t1 !== "number")
          return this.contains$1$bailout2(5, point, t1);
        t3 = this.top;
        if (typeof t3 !== "number")
          return this.contains$1$bailout2(6, point, t3, t1);
        if (t1 >= t3) {
          t2 = this.height;
          if (typeof t2 !== "number")
            return this.contains$1$bailout2(8, t3, t2, t1);
          t1 = t1 <= t3 + t2;
        } else
          t1 = false;
      } else
  ...
  contains$1$bailout2: function(state0, env0, env1, env2, env3) {
    switch (state0) {
      case 1:
        t1 = env1;
        point = env0;
...
$$.Coordinate = {"": "Object;x>,y>",
  ...
  operator$sub$1: function(other) {
    ...
    t1 = this.y;
    t3 = other.get$y();
    return $.Vector$(t2, $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t3));
  },
...
$$.TestVector_run__anon8 = {"": "Closure;",
  call$0: function() {
    $.expect($.CONSTANT20.get$angle(), $._IsCloseTo$(0, 0.001), null, null, false);
    $.expect($.CONSTANT21.get$angle(), $._IsCloseTo$(0.7853981633974483, 0.001), null, null, false);
    $.expect($.CONSTANT20.getAngle$1($.CONSTANT21), $._IsCloseTo$(0.7853981633974483, 0.001), null, null, false);
  },
  is$Function: true
};
...
$$.TestVector_run__anon9 = {"": "Closure;",
  call$0: function() {
    var a = $.CONSTANT18.rotate$1(1.5707963267948966);
...
$$.TestVector_run__anon10 = {"": "Closure;",
  call$0: function() {
    var a = $.CONSTANT18.rotateAroundPoint$2($.CONSTANT19, 1.5707963267948966);
...
$$.TestCoordinate_run__anon1 = {"": "Closure;",
  call$0: function() {
    ...
    $.expect($.CONSTANT16, $._IsSameAs$($.CONSTANT16), null, null, false);
  },
  is$Function: true
};
...
$$.TestRgbColor__testInvalidHex_anon = {"": "Closure;",
  call$1: function(hex) {
    $.expect(new $.TestRgbColor__testInvalidHex__anon(hex), $.CONSTANT15, null, null, false);
  },
  is$Function: true
};
...
$$.anon3 = {"": "Closure;this_0",
  call$2: function(rawValue, reply) {
    var value, _message, output, ex, exString, t1, exception;
    t1 = this.this_0;
...
$.TestArray2d__testReadonlyFromCtorParams = function() {
  ...
  $.expect(new $.TestArray2d__testReadonlyFromCtorParams_anon1(), $.CONSTANT15, null, null, false);
  $.expect(new $.TestArray2d__testReadonlyFromCtorParams_anon2(), $.CONSTANT15, null, null, false);
...
$.TestNumberEnumerable__testAverage = function() {
  ...
  $.expect(new $.TestNumberEnumerable__testAverage_anon(), $.CONSTANT12, null, null, false);
};
...
$.TestHslColor__testInvalid = function() {
  $.expect(new $.TestHslColor__testInvalid_anon(), $.CONSTANT15, null, null, false);
  $.expect(new $.TestHslColor__testInvalid_anon0(), $.CONSTANT15, null, null, false);
  $.expect(new $.TestHslColor__testInvalid_anon1(), $.CONSTANT15, null, null, false);
};
...
$.TestRgbColor__testInvalid = function() {
  $.expect(new $.TestRgbColor__testInvalid_anon(), $.CONSTANT15, null, null, false);
  $.expect(new $.TestRgbColor__testInvalid_anon0(), $.CONSTANT15, null, null, false);
  $.expect(new $.TestRgbColor__testInvalid_anon1(), $.CONSTANT15, null, null, false);
};
...
$.TestBox__testEquals = function() {
  $.expect($.CONSTANT17, $._DeepMatcher$($.CONSTANT17, 100), null, null, false);
  $.expect($.CONSTANT17, $._IsSameAs$($.CONSTANT17), null, null, false);
  $.expect($.CONSTANT17, $._DeepMatcher$($.CONSTANT17, 100), null, null, false);
  $.expect($.CONSTANT17, $._IsSameAs$($.CONSTANT17), null, null, false);
  var c = $.Box$(0, 0, 1, 1);
  $.expect(c, $._DeepMatcher$($.CONSTANT17, 100), null, null, false);
  $.expect(c, $._IsNot$($.wrapMatcher($._IsSameAs$($.CONSTANT17))), null, null, false);
};
...
$.TestFutureValueResult__testExceptionRoundTrip = function() {
  ...
  $.expect(newVal, $._DeepMatcher$(initialVal, 100), null, null, false);
  $.expect(newVal, $._IsNot$($.wrapMatcher($._IsSameAs$(initialVal))), null, null, false);
  $.expect(newVal.get$exception(), $._DeepMatcher$("oops", 100), null, null, false);
};
...
$._testThingParent = function() {
  ...
  child = $.ShapeThing$(10, 10, "blue", $.CONSTANT30);
  $.expect(child.get$parent(), $.CONSTANT5, null, null, false);
  $.expect(new $._testThingParent_anon(child), $.CONSTANT15, null, null, false);
  $.expect(new $._testThingParent_anon0(child), $.CONSTANT15, null, null, false);
  parentThing = $._TestParentThing$();
  child.registerParent$1(parentThing);
  $.expect(child.get$parent(), $.CONSTANT31, null, null, false);
  $.expect(new $._testThingParent_anon1(child, parentThing), $.CONSTANT14, null, null, false);
  child.unregisterParent$1(parentThing);
  $.expect(new $._testThingParent_anon2(child, parentThing), $.CONSTANT15, null, null, false);
  $.expect(child.get$parent(), $.CONSTANT5, null, null, false);
};

$._testRemoveTransform = function() {
  var thing, tx;
  thing = $.ShapeThing$(10, 10, "blue", $.CONSTANT30);
  $.expect(new $._testRemoveTransform_anon(thing), $.CONSTANT15, null, null, false);
...
$._testDoudbleClickManager = function() {
  var stage, cm;
  stage = $.Stage$($.CanvasElement_CanvasElement(null, null), $.ShapeThing$(100, 100, "blue", $.CONSTANT30));
...
$._testAddRemoveFromPanel = function() {
  ...
  $.expect(new $._testAddRemoveFromPanel_anon(panel), $.CONSTANT15, null, null, false);
  $.expect(panel.get$visualChildCount(), 0, null, null, false);
  shape = $.ShapeThing$(10, 10, "blue", $.CONSTANT30);
  $.expect(shape.get$parent(), $.CONSTANT5, null, null, false);
  panel.add$1(shape);
  $.expect(panel.get$visualChildCount(), 1, null, null, false);
  $.expect(shape.get$parent(), $.CONSTANT31, null, null, false);
  $.expect(new $._testAddRemoveFromPanel_anon0(panel, shape), $.CONSTANT15, null, null, false);
  $.expect(new $._testAddRemoveFromPanel_anon1(panel), $.CONSTANT15, null, null, false);
  $.expect(panel.remove$1(shape), $.CONSTANT6, null, null, false);
  $.expect(panel.get$visualChildCount(), 0, null, null, false);
  $.expect(shape.get$parent(), $.CONSTANT5, null, null, false);
  $.CanvasThing$(10, 10).add$1(shape);
  $.expect(new $._testAddRemoveFromPanel_anon2(panel, shape), $.CONSTANT15, null, null, false);
};
...
$.dynamicBind = function(obj, name$, methods, arguments$) {
  ...
  if (method == null)
    method = $.lookupDynamicClass(hasOwnPropertyFunction, methods, $.getTypeNameOf($.CONSTANT32));
...
$.dynamicFunction = function(name$) {
  ...
  if (!(f == null) && !!f.methods)
    return f.methods;
  methods = {};
  dartMethod = Object.getPrototypeOf($.CONSTANT32)[name$];
  if (!(dartMethod == null))
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    if ($.getInterceptor$JSString(t1).contains$2(t1, "Opera", 0) !== true) {
      ...
      t1 = false;
    if (t1 && $.CONSTANT24.containsKey$1(tag) === true)
      return $._ElementFactoryProvider__createTableForIE(html, tag);
    parentTag = $.CONSTANT25.operator$index$1(tag);
    if (parentTag == null)
      parentTag = "div";
  } else {
    tag = null;
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return (a + b) * a * b;
        if (a === 0 && $.CONSTANT28.get$isNegative(b) === true || $.CONSTANT28.get$isNaN(b) === true)
          return b;
        return a;
      }
      return a;
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return a + b;
        if ($.CONSTANT28.get$isNaN(b) === true)
          return b;
        return a;
      }
    ...
    if (typeof thing === "object" && thing !== null && !!thing.is$ParentThing) {
      ...
      for (t1 = length$ - 1, i = 0; i < length$; ++i) {
        ...
        if (typeof hits !== "object" || hits === null || hits.constructor !== Array || !!hits.fixed$length)
          return $.RetainedUtil__hitTest$bailout(2, thing, point, $.CONSTANT11, length$, hits, i);
        if (hits.length > 0)
          break;
      }
      thing = thing;
...
$.CONSTANT33 = Isolate.makeConstantList(["test", "test"]);
$.CONSTANT34 = Isolate.makeConstantList(["caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr"]);
$.CONSTANT24 = new Isolate.$isolateProperties.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, Isolate.$isolateProperties.CONSTANT34);
...
$.CONSTANT30 = new Isolate.$isolateProperties.ShapeType("Rect");
$.CONSTANT11 = new Isolate.$isolateProperties.JSNumber();
$.CONSTANT3 = new Isolate.$isolateProperties.JSInt();
$.CONSTANT20 = new Isolate.$isolateProperties.Vector(10, 0);
$.CONSTANT2 = new Isolate.$isolateProperties.JSString();
$.CONSTANT37 = new Isolate.$isolateProperties._ArgumentError("ArgumentError");
$.CONSTANT15 = new Isolate.$isolateProperties.Throws(Isolate.$isolateProperties.CONSTANT37);
$.CONSTANT17 = new Isolate.$isolateProperties.Box(0, 0, 1, 1);
$.CONSTANT16 = new Isolate.$isolateProperties.Coordinate(2, 2);
$.CONSTANT38 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CONSTANT19 = new Isolate.$isolateProperties.Coordinate(1, 0);
$.CONSTANT21 = new Isolate.$isolateProperties.Vector(10, 10);
$.CONSTANT22 = new Isolate.$isolateProperties.Vector(2, 2);
$.CONSTANT26 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CONSTANT27);
$.CONSTANT39 = Isolate.makeConstantList(["body", "head", "caption", "td", "th", "colgroup", "col", "tr", "tbody", "tfoot", "thead", "track"]);
$.CONSTANT40 = new Isolate.$isolateProperties._InvalidOperationError("InvalidOperationException");
$.CONSTANT12 = new Isolate.$isolateProperties.Throws(Isolate.$isolateProperties.CONSTANT40);
$.CONSTANT28 = new Isolate.$isolateProperties.JSDouble();
...
$.CONSTANT42 = new Isolate.$isolateProperties.Tuple("  \n \n", Isolate.$isolateProperties.CONSTANT41);
$.CONSTANT6 = new Isolate.$isolateProperties._IsTrue();
$.CONSTANT = new Isolate.$isolateProperties._IsFalse();
$.CONSTANT31 = new Isolate.$isolateProperties._IsNotNull();
$.CONSTANT14 = new Isolate.$isolateProperties.Throws(null);
$.CONSTANT43 = new Isolate.$isolateProperties.Tuple("\n", Isolate.$isolateProperties.CONSTANT35);
$.CONSTANT44 = Isolate.makeConstantList(["test"]);
$.CONSTANT4 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CONSTANT25 = new Isolate.$isolateProperties.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT39);
$.CONSTANT45 = new Isolate.$isolateProperties.Tuple("test", Isolate.$isolateProperties.CONSTANT44);
$.CONSTANT46 = new Isolate.$isolateProperties.Tuple("test\ntest", Isolate.$isolateProperties.CONSTANT33);
$.CONSTANT47 = new Isolate.$isolateProperties.Tuple("  \n  ", Isolate.$isolateProperties.CONSTANT36);
$.CONSTANT23 = Isolate.makeConstantList([Isolate.$isolateProperties.CONSTANT45, Isolate.$isolateProperties.CONSTANT46, Isolate.$isolateProperties.CONSTANT43, Isolate.$isolateProperties.CONSTANT47, Isolate.$isolateProperties.CONSTANT42, Isolate.$isolateProperties.CONSTANT42]);
$.CONSTANT32 = new Isolate.$isolateProperties.Object();
$.CONSTANT48 = new Isolate.$isolateProperties._NullArgumentError("NullArgumentException");
...
$.CONSTANT10 = new Isolate.$isolateProperties.Throws(Isolate.$isolateProperties.CONSTANT48);
$.CONSTANT18 = new Isolate.$isolateProperties.Vector(1, -1);
$.CONSTANT29 = new Isolate.$isolateProperties._Random();
...
$.isNotNull = Isolate.$isolateProperties.CONSTANT31;
$.isTrue = Isolate.$isolateProperties.CONSTANT6;
$.isFalse = Isolate.$isolateProperties.CONSTANT;
$.$throws = Isolate.$isolateProperties.CONSTANT14;
$.isArgumentError = Isolate.$isolateProperties.CONSTANT37;
$.throwsArgumentError = Isolate.$isolateProperties.CONSTANT15;
$._Sort__INSERTION_SORT_THRESHOLD = 32;
$._getTypeNameOf = null;
$._HashMapImpl__DELETED_KEY = Isolate.$isolateProperties.CONSTANT4;
$._HashMapImpl__INITIAL_CAPACITY = 8;
$._ElementFactoryProvider__CUSTOM_PARENT_TAG_MAP = Isolate.$isolateProperties.CONSTANT25;
$._ElementFactoryProvider__TABLE_TAGS = Isolate.$isolateProperties.CONSTANT24;
...
$.ShapeType_rect = Isolate.$isolateProperties.CONSTANT30;
