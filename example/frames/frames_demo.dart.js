...
$$.TxThing = {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _dragPosition$1: function(e) {
    ...
    t2 = e.get$delta();
    newValue = $.getInterceptor$JSNumber(t1).operator$add$1(t1, t2);
  ...
  get$_dragPosition: function() {
    return new $.BoundClosure(this, "_dragPosition$1");
  },
  ...
  _dragRotateScale$1: function(e) {
    var t1, t2, pc, t3, pointDeltaVector, t4, newScale, angle;
    t1 = this._rotateScaleCoordinate;
    t2 = e.get$delta();
    this._rotateScaleCoordinate = $.getInterceptor$JSNumber(t1).operator$add$1(t1, t2);
    pc = this.get$_positionCoordinate();
    t3 = this._rotateScaleCoordinate;
    pointDeltaVector = $.getInterceptor$JSNumber(t3).operator$sub$1(t3, pc);
    t3 = $.getInterceptor$JSStringJSArray(pointDeltaVector).get$length(pointDeltaVector);
    t4 = this._sourceSize.get$height();
    newScale = $.getInterceptor$JSNumber(t3).operator$div$1(t3, t4);
    angle = $.CONSTANT8.getAngle$1(pointDeltaVector);
    t4 = this._tx;
    t4.setToTranslation$2(pc.get$x(), pc.get$y());
    t4.rotate$3(angle, 0, 0);
    t4.scale$2(newScale, newScale);
    this._updatePoints$0();
  },
  get$_dragRotateScale: function() {
    return new $.BoundClosure(this, "_dragRotateScale$1");
  },
...
$$.AffineTransform = {"": "Object;_scX>,_shY>,_shX>,_scY>,_tX>,_tY>",
  ...
  transformCoordinate$0: function() {
    return this.transformCoordinate$1($.CONSTANT12);
  },
...
$$.MouseManager = {"": "Object;_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseOut$1: function(e) {
    ...
    $.get$MouseManager__mouseOutEvent().fireEvent$2(t1, $.CONSTANT4);
...
$$.Thing = {"": "AttachableObject;",
  ...
  _invalidateParent$0: function() {
    this._invalidatedEventHandle.fireEvent$1($.CONSTANT4);
...
$.TxThing_TxThing = function(width, height) {
  var t1, t2, t3, box, shape, tx;
  t1 = $.getInterceptor$JSNumber(width);
  t2 = t1.operator$div$1(width, 3);
  t3 = $.getInterceptor$JSNumber(height);
  box = $.Box$(t2, t3.operator$div$1(height, 3), t1.operator$div$1(width, 3), t3.operator$div$1(height, 3));
  shape = $.ShapeThing$(box.width, box.height, "blue", $.CONSTANT6);
...
$.TxThing$_internal = function(width, height, _sourceSize, _shape, _tx) {
  var t1 = new $.TxThing(_sourceSize, $.CanvasThing$(width, height), _shape, $.ShapeThing$(20, 20, "gray", $.CONSTANT6), $.ShapeThing$(20, 20, "red", $.CONSTANT6), _tx, null, $.List_List(0), $.EventHandle$(), null, width, height, 1, false, null, null, $.HashMap_HashMap(), $.HashMap_HashMap(), false);
    ...
    if (typeof thing === "object" && thing !== null && !!thing.is$ParentThing) {
      ...
      for (t1 = length$ - 1, i = 0; i < length$; ++i) {
        ...
        if (typeof hits !== "object" || hits === null || hits.constructor !== Array || !!hits.fixed$length)
          return $.RetainedUtil__hitTest$bailout(2, thing, point, $.CONSTANT10, length$, hits, i);
        if (hits.length > 0)
          break;
      }
      thing = thing;
...
$.CONSTANT4 = new Isolate.$isolateProperties.EventArgs();
...
$.CONSTANT12 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CONSTANT10 = new Isolate.$isolateProperties.JSNumber();
$.CONSTANT2 = new Isolate.$isolateProperties.JSInt();
$.CONSTANT = new Isolate.$isolateProperties.JSString();
$.CONSTANT9 = new Isolate.$isolateProperties.ShapeType("Ellipse");
$.CONSTANT11 = new Isolate.$isolateProperties.Object();
$.CONSTANT8 = new Isolate.$isolateProperties.Vector(0, 10);
...
$.ShapeType_ellipse = Isolate.$isolateProperties.CONSTANT9;
$.TxThing__widgetSize = 20;
